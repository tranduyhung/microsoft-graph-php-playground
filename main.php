...
while ($choice != 0) {
    ...
    echo('5. Get app role assignments'.PHP_EOL);
    echo('6. Set display name'.PHP_EOL);
...
function getAppRoleAssignments(): void {
    try {
        GraphHelper::getAppRoleAssignments();
    } catch (Exception $e) {
